...
public class ExplosiveEnhancementClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ParticleProviderRegistry.getInstance().register(ExplosiveEnhancement.BLASTWAVE, BlastWaveParticle.Factory::new);
        ParticleProviderRegistry.getInstance().register(ExplosiveEnhancement.FIREBALL, FireballParticle.Factory::new);
        ParticleProviderRegistry.getInstance().register(ExplosiveEnhancement.SPARKS, SparkParticle.Factory::new);
        ParticleProviderRegistry.getInstance().register(ExplosiveEnhancement.SMOKE, SmokeParticle.Factory::new);

        ParticleProviderRegistry.getInstance().register(ExplosiveEnhancement.WATER_BLASTWAVE, BlastWaveParticle.Factory::new);
        ParticleProviderRegistry.getInstance().register(ExplosiveEnhancement.SHOCKWAVE, FireballParticle.Factory::new);
        ParticleProviderRegistry.getInstance().register(ExplosiveEnhancement.WATER_SPARKS, SparkParticle.Factory::new);
        ParticleProviderRegistry.getInstance().register(ExplosiveEnhancement.BUBBLE, BubbleParticle.Factory::new);
    }
